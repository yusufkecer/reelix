...
abstract class  LocaleKeys {
  ...
  static const auth_login_register_text = 'auth.login.register_text';
  static const auth_login_register_button = 'auth.login.register_button';
  static const auth_login = 'auth.login';
  static const auth_register_title = 'auth.register.title';
  static const auth_register_name = 'auth.register.name';
  static const auth_register_password_again = 'auth.register.password_again';
  static const auth_register_register_button = 'auth.register.register_button';
  static const auth_register_agreement_agreement_part_1 = 'auth.register.agreement.agreement_part_1';
